...
{
	_myPort = myPort;
	_myI2CAddress = myI2CAddress;
	_scaler = 1.0;

	mraa_i2c_address(_myPort,myI2CAddress);
...
int16_t readADC()
{
	...
	mraa_i2c_read_bytes_data(_myPort, CONVERSION, result, 2);
...
uint16_t getConfigRegister()
{
	...
	mraa_i2c_read_bytes_data(_myPort, CONFIG, (uint8_t*)&cfgRegVal, 2);
